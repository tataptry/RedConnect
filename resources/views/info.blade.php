...
<div class="bg-white shadow-md rounded-xl p-6 border-l-4 border-red-600 flex flex-col justify-between">
  <div>
    ...
    <p class="text-gray-700 mb-4 text-lg leading-relaxed">
      Donor darah dapat membantu menyelamatkan hingga tiga nyawa. Prosesnya aman, cepat, dan juga bermanfaat bagi kesehatan pendonor.
      Rutin mendonor dapat menurunkan risiko penyakit jantung, meningkatkan kesehatan tubuh, dan memberikan rasa kebersamaan serta kepedulian terhadap sesama.
    </p>
